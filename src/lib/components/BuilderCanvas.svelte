<script lang="ts">
    ...
    import { kineticModelStore, model } from "$lib/modelStore";
    ...
    async function handleSave() {
      ...
      const modelData = get(kineticModelStore);
  
      try {
        await invoke('save_kinetic_model', { model: modelData });
        feedbackMessage = 'Model saved successfully!';
      } catch (error) {
  ...
  <div class="builder-container">
    <header class="top-bar">
      ...
      <button
        class="action-button"
        aria-pressed={showConductanceModal}
